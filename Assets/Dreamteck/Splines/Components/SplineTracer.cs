...
namespace Dreamteck.Splines
{
    public class SplineTracer : SplineUser
    {
        ...
        {
#if UNITY_EDITOR
            if (transformMode == TransformMode.Player && !UnityEditor.EditorApplication.isPlaying)
                return null;
#endif
            return transformMode == TransformMode.Self ? transform : transformMode == TransformMode.Player ? PlayerController.instance.transform : targetTransform;
        }
