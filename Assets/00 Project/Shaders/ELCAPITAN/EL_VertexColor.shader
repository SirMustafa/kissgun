...
Shader "ELCAPITAN/EL_VertexColor"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		[Enum(ToonyColorsPro.ShaderGenerator.Culling)] _faceCulling ("Face Culling", Float) = 0
...
/* TCP_DATA u config(unity:"2020.3.2f1";ver:"2.7.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","VERTEX_DISP_SHADER_FEATURE","SUBSURFACE_AMB_COLOR","SS_NO_LIGHTCOLOR","SS_MULTIPLICATIVE","MATCAP_PERSPECTIVE_CORRECTION","MATCAP_SHADER_FEATURE","ALBEDO_HSV","SPECULAR_NO_ATTEN","REFL_ROUGH","NO_AMBIENT","CUBE_AMBIENT","DIRAMBIENT","CURVED_WORLD_2020","SKETCH_AMBIENT","SKETCH_SHADER_FEATURE","SILHOUETTE_URP_FEATURE","SILHOUETTE_STENCIL","FOG","ENABLE_LIGHTMAP","SHADOW_HSV","BLEND_TEX1","BLEND_TEX2","BLEND_TEX3","BLEND_TEX4","AUTO_TRANSPARENT_BLENDING","SPECULAR","SPEC_LEGACY","SPECULAR_TOON","TEXTURED_THRESHOLD","OUTLINE_CONSTANT_SIZE","VERTICAL_FOG_COLOR","SSAO","WRAPPED_LIGHTING_CUSTOM","RIM_VERTEX","BUMP","BUMP_SCALE","SHADER_BLENDING","ALPHA_BLENDING","CULLING","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[pragma_gpu_instancing=list[]];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting",VERTEXMOTION_INCLUDE="Assets/VertExmotion/Shaders/VertExmotion.cginc",CURVED_WORLD_2020_INCLUDE="Assets/Amazing Assets/Curved World/Shaders/Core",CURVED_WORLD_INCLUDE="Assets/VacuumShaders/Curved World/Shaders/cginc/CurvedWorld_Base.cginc",BLEND_TEX1_CHNL="r",BLEND_TEX2_CHNL="g",BLEND_TEX3_CHNL="b",BLEND_TEX4_CHNL="a",GPU_INSTANCING_MAX_COUNT_VALUE="50"];shaderProperties:list[sp(name:"Albedo";imps:list[imp_vcolors(cc:4;chan:"RGBA";guid:"af3bbfea-b911-4974-b85a-dbea92a80377";op:Multiply;lbl:"Albedo";gpu_inst:False;locked:False;impl_index:-1),imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:True;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_Albedo";md:"";custom:False;refs:"";guid:"6c2c465b-7acf-4561-8e57-6ef3068e552d";op:Multiply;lbl:"Albedo Texture";gpu_inst:False;locked:False;impl_index:-1)]),,,,,,,,,,,,,,,,,,,,,,,sp(name:"Face Culling";imps:list[imp_enum(value_type:1;value:2;enum_type:"ToonyColorsPro.ShaderGenerator.Culling";guid:"501b1d58-c405-4647-8fb7-ead2a4146e49";op:Multiply;lbl:"Face Culling";gpu_inst:False;locked:False;impl_index:0)]),,,,,,,,,,,,,sp(name:"Vertical Fog Smoothness";imps:list[imp_mp_float(def:0;prop:"_VerticalFogSmoothness";md:"";custom:False;refs:"";guid:"911b7a9b-333c-42a5-be1f-6c011ea20a76";op:Multiply;lbl:"Smoothness";gpu_inst:False;locked:False;impl_index:0)]),sp(name:"Blend Operation";imps:list[imp_enum(value_type:1;value:0;enum_type:"ToonyColorsPro.ShaderGenerator.BlendOperation";guid:"5461c9e4-cf10-46e5-861a-b51c4c8e0aa7";op:Multiply;lbl:"Blend Operation";gpu_inst:False;locked:False;impl_index:0)])];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False)) */
/* TCP_HASH 606116ff4bd435c248cba524e796cdaa */
