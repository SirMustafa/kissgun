...
Shader "ELCAPITAN/VertexColor_VerticalFOG"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(unity:"2020.3.2f1";ver:"2.7.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","SSAO","FOG","ENABLE_LIGHTMAP","AUTO_TRANSPARENT_BLENDING","TEXTURED_THRESHOLD","ALBEDO_HSV","NO_AMBIENT","CUBE_AMBIENT","DIRAMBIENT","SHADOW_HSV","SPEC_LEGACY","SPECULAR","SPECULAR_TOON","VERTICAL_FOG","CURVED_WORLD_2020","VERTICAL_FOG_SMOOTHSTEP","VERTICAL_FOG_ALPHA","VERTICAL_FOG_COLOR","ALPHA_BLENDING","SHADER_BLENDING","WRAPPED_LIGHTING_CUSTOM","CULLING","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",CURVED_WORLD_2020_INCLUDE="Assets/Amazing Assets/Curved World/Shaders/Core"];shaderProperties:list[sp(name:"Albedo";imps:list[imp_vcolors(cc:4;chan:"RGBA";guid:"7ea07c00-3d78-421d-9fda-8f31d1102db6";op:Multiply;lbl:"Albedo";gpu_inst:False;locked:False;impl_index:-1),imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:True;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_Albedo";md:"";custom:False;refs:"";guid:"9c492814-f9ef-4bbc-a991-8c26c8c7a8d5";op:Multiply;lbl:"Albedo Texture";gpu_inst:False;locked:False;impl_index:-1)]),,,,,,,,,,,,,,,,,,,,,,sp(name:"Face Culling";imps:list[imp_enum(value_type:1;value:2;enum_type:"ToonyColorsPro.ShaderGenerator.Culling";guid:"0ee49128-4d5a-44c6-99b1-b0767b678c8a";op:Multiply;lbl:"Face Culling";gpu_inst:False;locked:False;impl_index:0)]),,,,,,,,,,,,,,,,,,,,sp(name:"Depth Write";imps:list[imp_enum(value_type:1;value:0;enum_type:"ToonyColorsPro.ShaderGenerator.DepthWrite";guid:"0080f07a-e31f-484a-bdbd-534963a64d04";op:Multiply;lbl:"Depth Write";gpu_inst:False;locked:False;impl_index:0)]),sp(name:"Depth Test";imps:list[imp_enum(value_type:1;value:2;enum_type:"ToonyColorsPro.ShaderGenerator.CompareFunction";guid:"5b2deea4-9279-463a-a6b2-f60231787868";op:Multiply;lbl:"Depth Test";gpu_inst:False;locked:False;impl_index:0)])];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False)) */
/* TCP_HASH 1f81bddccc8993c60ea21007cc5a5167 */
