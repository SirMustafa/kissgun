...
namespace MadLab.Editor {
    ...
    [CustomEditor(typeof(ML_WarningComment))]
    public class WarningCommentInspector : UnityEditor.Editor {
        
        private ML_WarningComment script { get { return target as ML_WarningComment; }}
		private GUIStyle style = new GUIStyle();
        private static Color pro = Utility.GetColorFromString("FFC107");
